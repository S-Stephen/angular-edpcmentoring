...
import { CamplNgMessageBufferService } from "../services/campl-ng-message-buffer.service";
...
@Component({
  ...
  templateUrl: "./campl-ng-messages.component.html",
  styleUrls: ["./campl-ng-messages.component.css"]
})
