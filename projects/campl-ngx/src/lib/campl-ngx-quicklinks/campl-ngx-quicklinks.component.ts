...
@Component({
  ...
  templateUrl: './campl-ngx-quicklinks.component.html',
  styleUrls: ['./campl-ngx-quicklinks.component.css']
...
export class CamplNgxQuicklinksComponent implements OnInit {
  ...
  public open_quicklinks = false; // used to toggle template
  ...
  public myid = 'CamplNgxQuicklinksComponent';
